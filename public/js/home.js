...
function openCourse(course) {
    var courses = {
        ...
        abm: {
            ...
            description: "The Accountancy, Business and Management (ABM) strand would focus on the basic concepts of financial management, business management, corporate operations, and all things that are accounted for. ABM can also lead you to careers on management and accounting which could be sales manager, human resources, marketing director, project officer, bookkeeper, accounting clerk, internal auditor, and a lot more."
        },
        gas: {
            title: "General Academic Strand",
            description: "While the other strands are career-specific, the General Academic Strand is great for students who are still undecided on which track to take. You can choose electives from the different academic strands under this track. These subjects include Humanities, Social Sciences, Applied Economics, Organization and Management, and Disaster Preparedness."
        },
        humss: {
            title: "Humanities and Social Sciences",
            description: "The HUMMS strand is designed for those who wonder what is on the other side of the wall. In other words, you are ready to take on the world and talk to a lot of people. This is for those who are considering taking up journalism, communication arts, liberal arts, education, and other social science-related courses in college. <br/> If you take this strand, you could be looking forward to becoming a teacher, a psychologist, a lawyer, a writer, a social worker, or a reporter someday. This strand focuses on improving your communication skills. "
        },
        stem: {
            title: "Science, Technology, Engineering and Mathematics",
            description: "Science, Technology, Engineering, and Mathematics are intertwining disciplines when applied in the real world. The difference of the STEM curriculum with the other strands and tracks is the focus on advanced concepts and topics.<br>Under the track, you can become a pilot, an architect, an astrophysicist, a biologist, a chemist, an engineer, a dentist, a nutritionist, a nurse, a doctor, and a lot more. Those who are also interested in Marine Engineering should take this track."
        },
        ict: {
            title: "Information and Communications Technology",
            description: "If you are computer-savvy or a technological freak, step right into the ICT strand. Under this strand, you will be encouraged to utilize information and communication technological tools to contextualize, collaborate, and create experiences for learning in this professional strand."
        },
        he: {
            title: "Home Economics",
            description: "The Home Economics track offers various specializations that can lead to livelihood projects at home. This strand aims to give you job-ready skills that can help you in finding the right employment."
        },
        pa: {
            title: "Performing Arts",
            description: "The strand introduces the students to principles of theater, music and dance and examines the practical application of the performing arts skills in the local and global market."
        },
        tesdaICT: {
            title: "Information and Communications Technology",
            description: " - Programming NCIV<br> - Visual Graphics NCIII<br> - Computer Hardware Servicing NCII"
        },
        tesdaHRS: {
            title: "Hospitality and Restaurant Services",
            description: " - Housekeeping NCII<br> - Tour Guiding NCII<br> - Bartending NCII<br> - Cookery NCII<br> - Bread and Pastry Production NCII<br> - Food and Beverage Services NCII<br> - Front Office Services NCII"
        },
        tesdaASR: {
            title: "Assessment and Review Center",
            description: "- Bartending NCII<br> - Bread and Pastry Production NCII<br> - Cookery NCII<br> - Food and Beverage Services NCII<br> - Tour Guiding NCII<br> - Housekeeping NCII<br> - Bookeeping NCII<br> - Front Office NCII<br> - Computer System Services NCII"
        },
    };
...
$(document).ready(function() {
    ...
    */
    ...
    var galleryFeed = new Instafeed({
        get: "user",
        userId: "14028030074",
        accessToken: "14028030074.4b5d1d3.ff070ed9dfb84780bbc04981f4d4d763",
        resolution: "standard_resolution",
        useHttp: "true",
        limit: 20,
        template: '<div class="grid-item"><a href="{{link}}" target="_blank"><div class="img-featured-container"><div class="img-backdrop"></div><div class="description-container"><p class="caption">{{caption}}</p><span class="likes"><i class="icon ion-heart"></i> {{likes}}</span><span class="comments"><i class="icon ion-chatbubble"></i> {{comments}}</span></div><img src="{{image}}" class="img-responsive"></div></a></div>',
